...
cluster_model = clustering(xValues=['Region', 'Units Sold', 'Total Revenue', 'targetvar'],columnsArray=columnsArray)

cluster_prof = cluster_profiling(cluster_model[0], xValues=['Region', 'Units Sold', 'Total Revenue', 'targetvar'])
